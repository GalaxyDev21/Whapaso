...
if ( ! function_exists( 'wp_bootstrap_4_woocommerce_wrapper_before' ) ) {
	...
	function wp_bootstrap_4_woocommerce_wrapper_before() {
		if( is_shop() ) : ?>
			<div class="parallax-window banner" data-parallax="scroll" data-image-src="/wp-content/uploads/2018/12/hwader-merch.jpg">
				<div class="container">
					<div class="row">
						<div class="col-md-5">
							<h1>The Diversity Line</h1>
							<h4 class="text-dark pb-md-4">The Diversity Line focus in the representation of diversity through everyday objects.</h4>
							<h6>100% of merchandise proceeds will be donated to St Jude Children's Hospital</h6>
						</div>
					</div>
				</div>
				<a class="explore-more" href="#primary"><img src="/wp-content/uploads/2018/11/ex-scroll.png" /></a>
			</div>
		<?php endif; ?>
		<div class="product-archive" id="primary">
			<div class="container">
				<div class="row0">
		<?php
	}
